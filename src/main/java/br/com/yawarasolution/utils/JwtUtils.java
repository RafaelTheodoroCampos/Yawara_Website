package br.com.yawarasolution.utils;
...
import br.com.yawarasolution.service.UserDetailsImpl;
...
public class JwtUtils {
  ...
  @Value("${yamarasolution.jwt.secret}")
  private String jwtSecret;

  @Value("${yamarasolution.jwt.expiration}")
