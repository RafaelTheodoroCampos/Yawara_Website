...
import br.com.yawarasolution.utils.ReadJsonFileToJsonObject;
...
public class OpenApiConfig {
	...
	public OpenAPI baseOpenAPI() throws IOException {
		...
		return new OpenAPI()
				...
				.info(new Info().title("Yawara Solution API")
						.version("V0.0.1")
						.description("API para a loja Yawara Solution")
						.contact(new Contact().name("Suporte Yawara Solution").email("support@YawaraSolution.com"))
						.termsOfService("http://YawaraSolution.com/terms")
